  ...
  class Animation {
    ...
    updateParcels() {
      ...
      for (let { place, address } of this.worldState.parcels) {
        ...
        node.style.cssText =
          'position: absolute; height: 16px; width: 16px; background-image: url(./images/parcel2x.png); background-position: 0 -' +
          offset +
          'px';
...
import VillageState from './scripts/02-the_task.js';
import lazy_robot from './scripts/07-robot_efficiency.js';
